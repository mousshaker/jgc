...
// Titre de la page
pageTitle($siteTitleShort,$page8);
...
<div class="wrapper" style="overflow-x:auto;">
	...
	<div class="marginBloc">
        Pour rappel, vous pouvez afficher la liste des gages <?php echo $page8 ?>s possibles : <button class="show"><?php echo $showHide ?></button>
    </div>
    <p>
