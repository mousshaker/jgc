...
// Titre de la page
pageTitle($siteTitleShort,$page1.' ('.$online.')');
...
if (isset($_POST['resultNb'])){// Si le bouton "des" est actionné
	...
	wLogGlobal($dataPathGlobal,$page1.' (online)',$choix);
...
<div class="wrapper" style="overflow-x:auto;">
	...
	<div class="marginBloc">
        Pour rappel, vous pouvez afficher la liste des gages <?php echo $page1 ?>s possibles : <button class="show"><?php echo $showHide ?></button>
    </div>
    <p>
